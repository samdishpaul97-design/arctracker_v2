...
WeeklyReview _weeklyReviewDeserialize(
  ...
  object.rating = reader.readDoubleOrNull(offsets[2]);
...
extension WeeklyReviewQueryFilter
  ...
  QueryBuilder<WeeklyReview, WeeklyReview, QAfterFilterCondition> notesEqualTo(
    String? value, {
  ...
  QueryBuilder<WeeklyReview, WeeklyReview, QAfterFilterCondition> notesLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<WeeklyReview, WeeklyReview, QAfterFilterCondition> notesBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<WeeklyReview, WeeklyReview, QAfterFilterCondition> notesEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WeeklyReview, WeeklyReview, QAfterFilterCondition> notesContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WeeklyReview, WeeklyReview, QAfterFilterCondition> notesMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WeeklyReview, WeeklyReview, QAfterFilterCondition> ratingEqualTo(
    double? value, {
  ...
  QueryBuilder<WeeklyReview, WeeklyReview, QAfterFilterCondition> ratingBetween(
    double? lower,
    double? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension WeeklyReviewQuerySortBy
  ...
  QueryBuilder<WeeklyReview, WeeklyReview, QAfterSortBy> sortByNotes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notes', Sort.asc);
    });
  }

  QueryBuilder<WeeklyReview, WeeklyReview, QAfterSortBy> sortByNotesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notes', Sort.desc);
    });
  }

  QueryBuilder<WeeklyReview, WeeklyReview, QAfterSortBy> sortByRating() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rating', Sort.asc);
    });
  }

  QueryBuilder<WeeklyReview, WeeklyReview, QAfterSortBy> sortByRatingDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension WeeklyReviewQuerySortThenBy
  ...
  QueryBuilder<WeeklyReview, WeeklyReview, QAfterSortBy> thenByNotes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notes', Sort.asc);
    });
  }

  QueryBuilder<WeeklyReview, WeeklyReview, QAfterSortBy> thenByNotesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notes', Sort.desc);
    });
  }

  QueryBuilder<WeeklyReview, WeeklyReview, QAfterSortBy> thenByRating() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rating', Sort.asc);
    });
  }

  QueryBuilder<WeeklyReview, WeeklyReview, QAfterSortBy> thenByRatingDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rating', Sort.desc);
    });
  }
...
extension WeeklyReviewQueryWhereDistinct
  ...
  QueryBuilder<WeeklyReview, WeeklyReview, QDistinct> distinctByNotes(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WeeklyReview, WeeklyReview, QDistinct> distinctByRating() {
    return QueryBuilder.apply(this, (query) {
...
extension WeeklyReviewQueryProperty
  ...
  QueryBuilder<WeeklyReview, String?, QQueryOperations> notesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'notes');
    });
  }

  QueryBuilder<WeeklyReview, double?, QQueryOperations> ratingProperty() {
    return QueryBuilder.apply(this, (query) {
