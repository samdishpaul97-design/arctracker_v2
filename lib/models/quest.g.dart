...
void _questSerialize(
  ...
  writer.writeLong(offsets[0], object.arcId);
...
Quest _questDeserialize(
  ...
  final object = Quest();
  object.arcId = reader.readLong(offsets[0]);
...
extension QuestQueryFilter on QueryBuilder<Quest, Quest, QFilterCondition> {
  QueryBuilder<Quest, Quest, QAfterFilterCondition> arcIdEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Quest, Quest, QAfterFilterCondition> arcIdGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Quest, Quest, QAfterFilterCondition> arcIdLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Quest, Quest, QAfterFilterCondition> arcIdBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Quest, Quest, QAfterFilterCondition> statusIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'status',
      ));
  ...
  QueryBuilder<Quest, Quest, QAfterFilterCondition> statusIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'status',
      ));
...
extension QuestQuerySortBy on QueryBuilder<Quest, Quest, QSortBy> {
  QueryBuilder<Quest, Quest, QAfterSortBy> sortByArcId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'arcId', Sort.asc);
    });
  }

  QueryBuilder<Quest, Quest, QAfterSortBy> sortByArcIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'arcId', Sort.desc);
    });
  }
...
extension QuestQuerySortThenBy on QueryBuilder<Quest, Quest, QSortThenBy> {
  QueryBuilder<Quest, Quest, QAfterSortBy> thenByArcId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'arcId', Sort.asc);
    });
  }

  QueryBuilder<Quest, Quest, QAfterSortBy> thenByArcIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'arcId', Sort.desc);
    });
  }
...
extension QuestQueryWhereDistinct on QueryBuilder<Quest, Quest, QDistinct> {
  QueryBuilder<Quest, Quest, QDistinct> distinctByArcId() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'arcId');
    });
  }
...
extension QuestQueryProperty on QueryBuilder<Quest, Quest, QQueryProperty> {
  ...
  QueryBuilder<Quest, int, QQueryOperations> arcIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'arcId');
    });
  }
  ...
  QueryBuilder<Quest, String?, QQueryOperations> statusProperty() {
    return QueryBuilder.apply(this, (query) {
